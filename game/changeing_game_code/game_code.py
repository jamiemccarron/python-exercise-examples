                ...
                while True:
                    ...
                    if choice3 == 1:
                        ...
                        while True:
                            ...
                            if choice4 == 1:
                                print(
                                    "you contiune to run away but all of a sudden you have this electric feeling in your in your back ")
                                ...
                                print(
                                    "you have been arrsed and sent to jail for 10 years for stealing a car speeding and running away from police.")

                            elif choice4 == 2:
                                print("you stop for police and they tackle you to the ground and then and cuff you")
                                print(
                                    "you are arresd and sent to jail for 10 years for speeding stealing a car and running away from police.")
                            else:
                                print(invalid())
                    else:
                        print(invalid())
